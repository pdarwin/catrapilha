export const validTags = [
  ...
  "1º Curso de capacitação sobre PPPs",
  ...
  "15ª turma do Projeto Pescar/Procempa",
  ...
  "Acidente",
  "Acidentalidade",
  "Acolhidos do Abrigo Municipal Bom Jesus ao Estádio Beira-Rio",
  "Acolhimento",
  ...
  "Apresentação dos Resultados do Esporte Verão",
  ...
  "Câncer Bucal",
  "Câncer de Mama",
  "Candidata do The Voice Kids Luiza Barbosa",
  "Cantata de Natal",
  "Capacitação",
  ...
  "Circuito Centro Histórico do Carnaval de Rua 2019",
  "Circuito Orla do Guaíba do Carnaval de Rua 2019",
  "Circuito Urbano",
  ...
  "Comitiva de Suzhou",
  "Comitiva portuguesa",
  "Comodoro do Clube Jangadeiros Pedro Pesce",
  ...
  "Cônsul-Geral dos Estados Unidos, Juliana Harlan",
  ...
  "Contrato de Prestação de Serviços de Exames de Ultrassonografia",
  ...
  "Curso de arquitetura da UFRGS",
  "Curso de Formação",
  "Curso de Mecânica",
  "curso de promotores da saúde LGBT",
  ...
  "Delegado Fernando Edison Domingues Soares",
  "Demhab",
  "Dengue",
  ...
  "Em Cena",
  "Embaixada",
  "Embaixador da França no Brasil Michel Miraillet",
  ...
  "Equipe da Prefeitura de Caxias do Sul",
  ...
  "Espetáculos em Comemoração à Semana de Porto Alegre",
  "Esporte",
  ...
  "Evento Semanas Internacionais IRLANDA",
  "evento social",
  ...
  "Finanças Públicas",
  "Financiamento",
  "Fisioterapeuta Luana Dellacorte",
  "Fios Soltos",
  "Fique Sabendo Jovem",
  "Fiscalização",
  ...
  "Início do Ano Letivo na Rede Pública de Ensino Municipal 2019",
  "Inovação",
  "Inspeção veicular",
  ...
  "Lago Guaíba",
  "Lançamento",
  "Lançamento da 3ª edição do Caminho de Porto Alegre",
  "Lançamento da Edição 2019 do projeto Banco do Tênis",
  "Lançamento da Pedra Fundamental do Hospital Nora Teixeira",
  "Lançamento da Terceira Edição da Campanha Cabide Solidário",
  "Lançamento das Atividades Alusivas aos 247 anos de Porto Alegre",
  ...
  "Obras de qualificação na praça Major Joaquim Queiróz",
  ...
  "porteiros",
  "Porto Alegre",
  "Porto Alegre Capital das Microcervejarias Artesanais",
  ...
  "Posse da Secretária Estadual Ana Amélia Lemos",
  "Posse Deputados Estaduais",
  "Posse do Diretor-Geral dos Direitos Humanos da SMDSE",
  ...
  "Premiação",
  "Prêmio Açorianos",
  "Prêmio Açorianos de Música 2019",
  "Prêmio Inovação",
  ...
  "Primeira Edição da Jornada de Estudos em Defesa do Adolescente",
  ...
  "Programa Balanço Geral da Record RS",
  ...
  "Programa Poa + Social",
  "Programa Primeira Infância Melhor ( PIM PIA)",
  ...
  "Reunião com as Escolas Infantis da Rede",
  ...
  "Reunião ordinária da Comissão de Saúde e Meio Ambiente (Cosmam)",
  ...
  "Sanção de Leis para desburocratizar Podas de Árvores",
  "sanção de Projeto de Lei",
  "Sanção do PL do programa Família Acolhedora",
  "Sangue",
  ...
  "Sol",
  "Solenidade de Passagem de Comando de Policiamento da Capital",
  ...
  "Treinamento para uso de cadeira para descida de escada",
  "Trensurb",
